...
namespace WebApiAutores.Migrations
{
    ...
    [Migration("20220111154823_AutoresLibros")]
            ...
            modelBuilder.Entity("WebApiAutores.Entidades.AutorLibro", b =>
                {
                    b.HasOne("WebApiAutores.Entidades.Autor", "autor")
                        .WithOne("AutoresLibros")
                        .HasForeignKey("WebApiAutores.Entidades.AutorLibro", "AutorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApiAutores.Entidades.Libro", "libro")
                        .WithOne("AutoresLibros")
                        .HasForeignKey("WebApiAutores.Entidades.AutorLibro", "LibroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
